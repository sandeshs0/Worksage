function TermsPage() {
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <p className="text-gray-700 mb-2">Welcome to Cubicle! By using our service, you agree to the following terms:</p>
      ...
      <p className="text-gray-700">For more details, contact support at support@cubicle.com.</p>
    </div>
  );
}
